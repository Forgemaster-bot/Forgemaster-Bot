...
class Crafting_Commands(commands.Cog):
        ...
        if not command_check[0]:
            ...
            while crafting:
                ...
                if SQL_Check.character_has_multiple_profession(character_name):
                    ...
                    craft_skill = SQL_Lookup.character_skill_profession(character_name)[0]
    ...
    async def pick_craft_skill(self, command, character_name):
        ...
        while True:
            ...
            await command.message.author.send("{} is not on the list, please pick a profession".format(crafting_skill))
