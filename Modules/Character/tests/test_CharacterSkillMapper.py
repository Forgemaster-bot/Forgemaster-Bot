...
from Character import CharacterSkillFacade as Facade
from Character.Data.CharacterSkill import CharacterSkill as DataClass

test_data = {'character_id': '0E984725-C51C-4BF4-9960-E1C80E27ABA0',
             'name': 'Smithing',
             'proficiency': 1}

test_update_field = 'proficiency'
