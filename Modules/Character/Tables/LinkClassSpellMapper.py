...
class LinkClassSpellMapper(TableMapper):
    """
    LinkClassSpell mapper
    """
...
class Constants(str, Enum):
    """
    Storage for Link_Class_Spells column/db labels and info
    """
    table = "Link_Class_Spells"
    key = "Class"
    # -------------------------- #
    class_name = key
    spell_name = 'Spell'
...
mapper = LinkClassSpellMapper(Queries, Constants, LinkClassSpell)
